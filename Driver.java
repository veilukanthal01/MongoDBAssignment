...
public class Driver {
    public static void main(String[] args) throws SQLException {
        ...
        try {
            ...
            CRUDHelper.displayCategoryOrderedProductsDescending(productsCollection);

            // Display product count in each category
            CRUDHelper.displayProductCountByCategory(productsCollection);


            // Display wired headphones
            CRUDHelper.displayWiredHeadphones(productsCollection);
